...
def main():
    outFile = open(r'ML code/multiChannelDBNPCA.txt', 'w')
   ...
   #check accuracy, using mean squared error now that it's a regression
    ...
    outFile.write('Arousal1 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest1, arousalPredicts1))+'\n')
    outFile.write('Arousal1 r^2: '+ str(metrics.r2_score(arousalYTest1, arousalPredicts1))+'\n')
    outFile.write('Valence1 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest1, valencePredicts1))+'\n')
    outFile.write('Valence1 r^2: '+ str(metrics.r2_score(valenceYTest1, valencePredicts1))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal2 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest2, arousalPredicts2))+'\n')
    outFile.write('Arousal2 r^2: '+ str(metrics.r2_score(arousalYTest2, arousalPredicts2))+'\n')
    outFile.write('Valence2 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest2, valencePredicts2))+'\n')
    outFile.write('Valence2 r^2: '+ str(metrics.r2_score(valenceYTest2, valencePredicts2))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal3 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest3, arousalPredicts3))+'\n')
    outFile.write('Arousal3 r^2: '+ str(metrics.r2_score(arousalYTest3, arousalPredicts3))+'\n')
    outFile.write('Valence3 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest3, valencePredicts3))+'\n')
    outFile.write('Valence3 r^2: '+ str(metrics.r2_score(valenceYTest3, valencePredicts3))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal4 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest4, arousalPredicts4))+'\n')
    outFile.write('Arousal4 r^2: '+ str(metrics.r2_score(arousalYTest4, arousalPredicts4))+'\n')
    outFile.write('Valence4 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest4, valencePredicts4))+'\n')
    outFile.write('Valence4 r^2: '+ str(metrics.r2_score(valenceYTest4, valencePredicts4))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal5 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest5, arousalPredicts5))+'\n')
    outFile.write('Arousal5 r^2: '+ str(metrics.r2_score(arousalYTest5, arousalPredicts5))+'\n')
    outFile.write('Valence5 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest5, valencePredicts5))+'\n')
    outFile.write('Valence5 r^2: '+ str(metrics.r2_score(valenceYTest5, valencePredicts5))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal6 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest6, arousalPredicts6))+'\n')
    outFile.write('Arousal6 r^2: '+ str(metrics.r2_score(arousalYTest6, arousalPredicts6))+'\n')
    outFile.write('Valence6 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest6, valencePredicts6))+'\n')
    outFile.write('Valence6 r^2: '+ str(metrics.r2_score(valenceYTest6, valencePredicts6))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal7 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest7, arousalPredicts7))+'\n')
    outFile.write('Arousal7 r^2: '+ str(metrics.r2_score(arousalYTest7, arousalPredicts7))+'\n')
    outFile.write('Valence7 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest7, valencePredicts7))+'\n')
    outFile.write('Valence7 r^2: '+ str(metrics.r2_score(valenceYTest7, valencePredicts7))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal8 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest8, arousalPredicts8))+'\n')
    outFile.write('Arousal8 r^2: '+ str(metrics.r2_score(arousalYTest8, arousalPredicts8))+'\n')
    outFile.write('Valence8 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest8, valencePredicts8))+'\n')
    outFile.write('Valence8 r^2: '+ str(metrics.r2_score(valenceYTest8, valencePredicts8))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal9 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest9, arousalPredicts9))+'\n')
    outFile.write('Arousal9 r^2: '+ str(metrics.r2_score(arousalYTest9, arousalPredicts9))+'\n')
    outFile.write('Valence9 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest9, valencePredicts9))+'\n')
    outFile.write('Valence9 r^2: '+ str(metrics.r2_score(valenceYTest9, valencePredicts9))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal10 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest10, arousalPredicts10))+'\n')
    outFile.write('Arousal10 r^2: '+ str(metrics.r2_score(arousalYTest10, arousalPredicts10))+'\n')
    outFile.write('Valence10 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest10, valencePredicts10))+'\n')
    outFile.write('Valence10 r^2: '+ str(metrics.r2_score(valenceYTest10, valencePredicts10))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal11 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest11, arousalPredicts11))+'\n')
    outFile.write('Arousal11 r^2: '+ str(metrics.r2_score(arousalYTest11, arousalPredicts11))+'\n')
    outFile.write('Valence11 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest11, valencePredicts11))+'\n')
    outFile.write('Valence11 r^2: '+ str(metrics.r2_score(valenceYTest11, valencePredicts11))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal12 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest12, arousalPredicts12))+'\n')
    outFile.write('Arousal12 r^2: '+ str(metrics.r2_score(arousalYTest12, arousalPredicts12))+'\n')
    outFile.write('Valence12 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest12, valencePredicts12))+'\n')
    outFile.write('Valence12 r^2: '+ str(metrics.r2_score(valenceYTest12, valencePredicts12))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal13 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest13, arousalPredicts13))+'\n')
    outFile.write('Arousal13 r^2: '+ str(metrics.r2_score(arousalYTest13, arousalPredicts13))+'\n')
    outFile.write('Valence13 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest13, valencePredicts13))+'\n')
    outFile.write('Valence13 r^2: '+ str(metrics.r2_score(valenceYTest13, valencePredicts13))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal14 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest14, arousalPredicts14))+'\n')
    outFile.write('Arousal14 r^2: '+ str(metrics.r2_score(arousalYTest14, arousalPredicts14))+'\n')
    outFile.write('Valence14 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest14, valencePredicts14))+'\n')
    outFile.write('Valence14 r^2: '+ str(metrics.r2_score(valenceYTest14, valencePredicts14))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal15 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest15, arousalPredicts15))+'\n')
    outFile.write('Arousal15 r^2: '+ str(metrics.r2_score(arousalYTest15, arousalPredicts15))+'\n')
    outFile.write('Valence15 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest15, valencePredicts15))+'\n')
    outFile.write('Valence15 r^2: '+ str(metrics.r2_score(valenceYTest15, valencePredicts15))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal16 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest16, arousalPredicts16))+'\n')
    outFile.write('Arousal16 r^2: '+ str(metrics.r2_score(arousalYTest16, arousalPredicts16))+'\n')
    outFile.write('Valence16 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest16, valencePredicts16))+'\n')
    outFile.write('Valence16 r^2: '+ str(metrics.r2_score(valenceYTest16, valencePredicts16))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal17 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest17, arousalPredicts17))+'\n')
    outFile.write('Arousal17 r^2: '+ str(metrics.r2_score(arousalYTest17, arousalPredicts17))+'\n')
    outFile.write('Valence17 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest17, valencePredicts17))+'\n')
    outFile.write('Valence17 r^2: '+ str(metrics.r2_score(valenceYTest17, valencePredicts17))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal18 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest18, arousalPredicts18))+'\n')
    outFile.write('Arousal18 r^2: '+ str(metrics.r2_score(arousalYTest18, arousalPredicts18))+'\n')
    outFile.write('Valence18 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest18, valencePredicts18))+'\n')
    outFile.write('Valence18 r^2: '+ str(metrics.r2_score(valenceYTest18, valencePredicts18))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal19 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest19, arousalPredicts19))+'\n')
    outFile.write('Arousal19 r^2: '+ str(metrics.r2_score(arousalYTest19, arousalPredicts19))+'\n')
    outFile.write('Valence19 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest19, valencePredicts19))+'\n')
    outFile.write('Valence19 r^2: '+ str(metrics.r2_score(valenceYTest19, valencePredicts19))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal20 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest20, arousalPredicts20))+'\n')
    outFile.write('Arousal20 r^2: '+ str(metrics.r2_score(arousalYTest20, arousalPredicts20))+'\n')
    outFile.write('Valence20 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest20, valencePredicts20))+'\n')
    outFile.write('Valence20 r^2: '+ str(metrics.r2_score(valenceYTest20, valencePredicts20))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal21 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest21, arousalPredicts21))+'\n')
    outFile.write('Arousal21 r^2: '+ str(metrics.r2_score(arousalYTest21, arousalPredicts21))+'\n')
    outFile.write('Valence21 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest21, valencePredicts21))+'\n')
    outFile.write('Valence21 r^2: '+ str(metrics.r2_score(valenceYTest21, valencePredicts21))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal22 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest22, arousalPredicts22))+'\n')
    outFile.write('Arousal22 r^2: '+ str(metrics.r2_score(arousalYTest22, arousalPredicts22))+'\n')
    outFile.write('Valence22 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest22,valencePredicts22))+'\n')
    outFile.write('Valence22 r^2: '+ str(metrics.r2_score(valenceYTest22, valencePredicts22))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal23 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest23, arousalPredicts23))+'\n')
    outFile.write('Arousal23 r^2: '+ str(metrics.r2_score(arousalYTest23, arousalPredicts23))+'\n')
    outFile.write('Valence23 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest23, valencePredicts23))+'\n')
    outFile.write('Valence23 r^2: '+ str(metrics.r2_score(valenceYTest23, valencePredicts23))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal24 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest24, arousalPredicts24))+'\n')
    outFile.write('Arousal24 r^2: '+ str(metrics.r2_score(arousalYTest24, arousalPredicts24))+'\n')
    outFile.write('Valence24 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest24, valencePredicts24))+'\n')
    outFile.write('Valence24 r^2: '+ str(metrics.r2_score(valenceYTest24, valencePredicts24))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal25 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest25, arousalPredicts25))+'\n')
    outFile.write('Arousal25 r^2: '+ str(metrics.r2_score(arousalYTest25, arousalPredicts25))+'\n')
    outFile.write('Valence25 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest25, valencePredicts25))+'\n')
    outFile.write('Valence25 r^2: '+ str(metrics.r2_score(valenceYTest25, valencePredicts25))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal26 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest26, arousalPredicts26))+'\n')
    outFile.write('Arousal26 r^2: '+ str(metrics.r2_score(arousalYTest26, arousalPredicts26))+'\n')
    outFile.write('Valence26 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest26, valencePredicts26))+'\n')
    outFile.write('Valence26 r^2: '+ str(metrics.r2_score(valenceYTest26, valencePredicts26))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal27 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest27, arousalPredicts27))+'\n')
    outFile.write('Arousal27 r^2: '+ str(metrics.r2_score(arousalYTest27, arousalPredicts27))+'\n')
    outFile.write('Valence27 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest27, valencePredicts27))+'\n')
    outFile.write('Valence27 r^2: '+ str(metrics.r2_score(valenceYTest27, valencePredicts27))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal28 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest28, arousalPredicts28))+'\n')
    outFile.write('Arousal28 r^2: '+ str(metrics.r2_score(arousalYTest28, arousalPredicts28))+'\n')
    outFile.write('Valence28 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest28, valencePredicts28))+'\n')
    outFile.write('Valence28 r^2: '+ str(metrics.r2_score(valenceYTest28, valencePredicts28))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal29 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest29, arousalPredicts29))+'\n')
    outFile.write('Arousal29 r^2: '+ str(metrics.r2_score(arousalYTest29, arousalPredicts29))+'\n')
    outFile.write('Valence29 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest29, valencePredicts29))+'\n')
    outFile.write('Valence29 r^2: '+ str(metrics.r2_score(valenceYTest29, valencePredicts29))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal30 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest30, arousalPredicts30))+'\n')
    outFile.write('Arousal30 r^2: '+ str(metrics.r2_score(arousalYTest30, arousalPredicts30))+'\n')
    outFile.write('Valence30 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest30, valencePredicts30))+'\n')
    outFile.write('Valence30 r^2: '+ str(metrics.r2_score(valenceYTest30, valencePredicts30))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal31 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest31, arousalPredicts31))+'\n')
    outFile.write('Arousal31 r^2: '+ str(metrics.r2_score(arousalYTest31, arousalPredicts31))+'\n')
    outFile.write('Valence31 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest31, valencePredicts31))+'\n')
    outFile.write('Valence31 r^2: '+ str(metrics.r2_score(valenceYTest31, valencePredicts31))+'\n')
    outFile.write('\n')
    ...
    outFile.write('Arousal32 Mean Squared Error: '+str(metrics.mean_squared_error(arousalYTest32, arousalPredicts32))+'\n')
    outFile.write('Arousal32 r^2: '+ str(metrics.r2_score(arousalYTest32, arousalPredicts32))+'\n')
    outFile.write('Valence32 Mean Squared Error: '+str(metrics.mean_squared_error(valenceYTest32, valencePredicts32))+'\n')
    outFile.write('Valence32 r^2: '+ str(metrics.r2_score(valenceYTest32, valencePredicts32))+'\n')
   #end
    outFile.close()
    print('Done')
