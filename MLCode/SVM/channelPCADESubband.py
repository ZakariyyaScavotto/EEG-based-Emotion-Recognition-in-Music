...
def main():
    outFile = open(r'ML code/channelPCADESubbandOutput.txt', 'w')
  #SVM For all channels  
   ...
   #look at accuracies
    ...
    outFile.write('All channel arousal Accuracy: '+str(metrics.accuracy_score(arousalYTest, arousalPredicts))+'\n')
    print('All channel valence Accuracy: ',metrics.accuracy_score(valenceYTest, valencePredicts))
    outFile.write('All channel valence Accuracy: '+str(metrics.accuracy_score(valenceYTest, valencePredicts))+'\n')
  ...
  #SVM for individual channels
    ...
    for channelInd in range(32): #32 channels
       ...
       #look at accuracies
        ...
        outFile.write(channelList[channelInd]+' arousal Accuracy: '+str(metrics.accuracy_score(arousalYTest, arousalPredicts))+'\n')
        print(channelList[channelInd]+' valence Accuracy: ',metrics.accuracy_score(valenceYTest, valencePredicts))
        outFile.write(channelList[channelInd]+' valence Accuracy: '+str(metrics.accuracy_score(valenceYTest, valencePredicts))+'\n')
        print()
        outFile.write('\n')
