...
def main():
    ...
    dump(channel0ArousalGrid, 'channel0ArousalSVM.joblib')
    dump(channel0ValenceGrid, 'channel0ValenceSVM.joblib')
    ...
    dump(channel1ArousalGrid, 'channel1ArousalSVM.joblib')
    dump(channel1ValenceGrid, 'channel1ValenceSVM.joblib')
    ...
    dump(channel2ArousalGrid, 'channel2ArousalSVM.joblib')
    dump(channel2ValenceGrid, 'channel2ValenceSVM.joblib')
    ...
    dump(channel3ArousalGrid, 'channel3ArousalSVM.joblib')
    dump(channel3ValenceGrid, 'channel3ValenceSVM.joblib')
    ...
    dump(channel4ArousalGrid, 'channel4ArousalSVM.joblib')
    dump(channel4ValenceGrid, 'channel4ValenceSVM.joblib')
    ...
    dump(channel5ArousalGrid, 'channel5ArousalSVM.joblib')
    dump(channel5ValenceGrid, 'channel5ValenceSVM.joblib')
    ...
    dump(channel6ArousalGrid, 'channel6ArousalSVM.joblib')
    dump(channel6ValenceGrid, 'channel6ValenceSVM.joblib')
    ...
    dump(channel7ArousalGrid, 'channel7ArousalSVM.joblib')
    dump(channel7ValenceGrid, 'channel7ValenceSVM.joblib')
    ...
    dump(channel8ArousalGrid, 'channel8ArousalSVM.joblib')
    dump(channel8ValenceGrid, 'channel8ValenceSVM.joblib')
    ...
    dump(channel9ArousalGrid, 'channel9ArousalSVM.joblib')
    dump(channel9ValenceGrid, 'channel9ValenceSVM.joblib')
    ...
    dump(channel10ArousalGrid, 'channel10ArousalSVM.joblib')
    dump(channel10ValenceGrid, 'channel10ValenceSVM.joblib')
    ...
    dump(channel11ArousalGrid, 'channel11ArousalSVM.joblib')
    dump(channel11ValenceGrid, 'channel11ValenceSVM.joblib')
    ...
    dump(channel12ArousalGrid, 'channel12ArousalSVM.joblib')
    dump(channel12ValenceGrid, 'channel12ValenceSVM.joblib')
    ...
    dump(channel13ArousalGrid, 'channel13ArousalSVM.joblib')
    dump(channel13ValenceGrid, 'channel13ValenceSVM.joblib')
